...
public interface IConversationProgressLogService
{
    ...
    ValueTask<ConversationProgressLog> CreatePlanAsync(
    ...
    ValueTask<ConversationProgressLog> RecordArtifactAsync(
            string conversationId,
            Guid planId,
            string artifactKey,
    ...
    ValueTask<ConversationProgressLog> SetCurrentStepAsync(
            string conversationId,
            Guid planId,
            int stepId,
