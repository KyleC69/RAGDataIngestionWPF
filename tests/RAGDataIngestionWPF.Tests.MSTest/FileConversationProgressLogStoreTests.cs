...
public class FileConversationProgressLogStoreTests
{
    ...
    public void Constructor_CustomRootDirectory_UsesProvidedPath()
    {
        ...
        var customRoot = Path.Combine(Path.GetTempPath(), "custom-root");
    ...
    public async Task Constructor_EmptyRootDirectory_UsesEmptyStringAsRoot()
    {
        ...
        var result = await store.ListAsync("test-conversation", CancellationToken.None);
    ...
    public async Task DeleteConversationAsyncRemovesAllPlans()
    {
        ...
        var plans = await store.ListAsync("conversation-1", CancellationToken.None);
    ...
    public async Task ListAsync_EmptyConversationId_ReturnsEmptyList()
    {
        ...
        var result = await store.ListAsync(string.Empty, CancellationToken.None);
    ...
    public async Task ListAsync_NullConversationId_ReturnsEmptyList()
    {
        ...
        var result = await store.ListAsync(null!, CancellationToken.None);
    ...
    public async Task SaveAsync_EmptyConversationId_ThrowsArgumentException()
    {
        ...
        ArgumentException ex = await Assert.ThrowsExactlyAsync<ArgumentException>(async () => await store.SaveAsync(plan, CancellationToken.None));
