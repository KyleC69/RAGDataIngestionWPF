...
public class WindowsDiagnosticsRichIntegrationTests
{
    ...
    public void WindowsWmiReaderToolOperatingSystemReturnsExpectedProperties()
    {
        ...
        ToolResult<IReadOnlyList<WindowsWmiInstanceDto>> result = tool.ReadClass("Win32_OperatingSystem", "Caption,Version,LastBootUpTime", 1);
    ...
    public void WindowsEventChannelReaderToolSystemChannelReturnsStructuredEntries()
    {
        ...
        ToolResult<IReadOnlyList<WindowsEventChannelEntryDto>> result = tool.ReadChannel("System", 2);
    ...
    public void NetworkConfigurationToolReturnsTrimmedActiveAdapterDetails()
    {
        ...
        ToolResult<IReadOnlyList<NetworkConfigurationSnapshot>> result = tool.ReadActiveAdapters(2);
